# OLD-README (archived 2026-09-24)

Historical/analysis record of the Lars UI direction. **Deprecated** — kept for reference only.
See `README.md` for the current build plan. Much of this describes paths that were tried and
rejected (dashboard themes, dashboard UI plugins with iframes/`tab.override`, the "25% chat module,
full-width chat module" spec from the pre-desktop-SDK era).

---

# lars-hermes-theme  (original README content follows)
